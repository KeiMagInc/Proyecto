...
Característica: Revisión de datos del paciente
  ...
  Escenario: Acceso a datos del paciente
    Dado que el médico ha iniciado sesión en la app
    Cuando selecciona un paciente de su lista
    Entonces puede ver el historial de migrañas, informes y estadísticas
  ...
  Escenario: Visualización sin datos registrados
    ...
    Y no se muestran estadísticas ni archivos de informe
